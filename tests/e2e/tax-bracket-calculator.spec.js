...
const SVC_URL = "https://appadaycreator.com/tax-bracket-calculator/";
const SVC_NAME = "所得税率・税額計算ツール";

test.describe("所得税率・税額計算ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("tax-bracket-calculator");
